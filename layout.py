...
def make_layout(valid_ids, dim):
    ...
    top_height_layout = [[sg.Text('Top', font=('',15),pad=((32,0),(15,0))), sg.Text('Height', font=('',15), pad=((18,0),(15,0)))],
                         [sg.Slider(range=(1, 100), orientation='v', size=(16, 25), pad=((10, 0),(10,25)), default_value=dim.T, key='T',enable_events=True),
                          sg.Slider(range=(100, 1), orientation='v', size=(16, 25), pad=((10,5),(10,25)), default_value=dim.H, key='H',enable_events=True)]
                         ]
    ...
    left_width_layout = [[
        ...
        [sg.Text('Width', font=('',15), pad=((30,0),(0,0))), sg.Slider(range=(1, 100), orientation='h', size=(46, 20), pad=((10,26),(0,10)),
                                                                   default_value=dim.W, key='W',enable_events=True)]]
    ...
    chroma_layout = [
        [sg.Text('Hue LoPass', font=('',15), pad=(10,(12,0))),
         sg.Slider(range=(1, 255),orientation='h',size=(20, 20), default_value=dim.hue_loPass,key='hue_loPass',enable_events=True)],
        [sg.Text('Hue HiPass', font=('',15), pad=(10,(12,0))),
         sg.Slider(range=(1, 255), orientation='h',size=(20, 20), default_value=dim.hue_hiPass, key='hue_hiPass',enable_events=True)],
        [sg.Text('Sat LoPass', font=('',15), pad=(10,(12,0))),
         sg.Slider(range=(1, 255), orientation='h',size=(20, 20), default_value=dim.sat_loPass, key='sat_loPass',enable_events=True)],
        [sg.Text('Bright LoPass', font=('',15), pad=(10,(12,0))),
         sg.Slider(range=(1, 255), orientation='h',size=(20, 20), default_value=dim.bright_loPass, key='bright_loPass',enable_events=True)],
        ...
        [sg.Text('Scale', font=('',15), pad=(10,(12,0))),
         sg.Slider(range=(1, 24),orientation='h',size=(20, 20), default_value=dim.scale, resolution = 0.25, key='scale', enable_events=True)],
    ]
